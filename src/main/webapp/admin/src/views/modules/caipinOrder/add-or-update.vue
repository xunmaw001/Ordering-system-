    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="24" v-if="sessionTable !='caipin' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='canzhuo'">
                    <el-form-item class="select" v-if="type!='info'"  label="餐桌" prop="canzhuoId">
                        <el-select v-model="ruleForm.canzhuoId" :disabled="ro.canzhuoId" filterable placeholder="请选择餐桌" @change="canzhuoChange">
                            <el-option
                                    v-for="(item,index) in canzhuoOptions"
                                    v-bind:key="item.id"
                                    :label="item.canzhuoName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='canzhuo' ">
                    <el-form-item class="input" v-if="type!='info'"  label="餐桌名称" prop="canzhuoName">
                        <el-input v-model="canzhuoForm.canzhuoName"
                                  placeholder="餐桌名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="餐桌名称" prop="canzhuoName">
                            <el-input v-model="ruleForm.canzhuoName"
                                      placeholder="餐桌名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="sessionTable !='canzhuo' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.canzhuoPhoto" label="餐桌图片" prop="canzhuoPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (canzhuoForm.canzhuoPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.canzhuoPhoto" label="餐桌图片" prop="canzhuoPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.canzhuoPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='canzhuo' ">
                    <el-form-item class="input" v-if="type!='info'"  label="餐桌位置" prop="canzhuoAddress">
                        <el-input v-model="canzhuoForm.canzhuoAddress"
                                  placeholder="餐桌位置" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="餐桌位置" prop="canzhuoAddress">
                            <el-input v-model="ruleForm.canzhuoAddress"
                                      placeholder="餐桌位置" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='canzhuo' ">
                    <el-form-item class="input" v-if="type!='info'"  label="是否使用" prop="shiyongValue">
                        <el-input v-model="canzhuoForm.shiyongValue"
                                  placeholder="是否使用" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="是否使用" prop="shiyongValue">
                            <el-input v-model="ruleForm.shiyongValue"
            ...
            <input id="canzhuoId" name="canzhuoId" type="hidden">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格/积分" prop="caipinOrderTruePrice">
                       <el-input v-model="ruleForm.caipinOrderTruePrice"
                                 placeholder="实付价格/积分" clearable  :readonly="ro.caipinOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="实付价格/积分" prop="caipinOrderTruePrice">
                           <el-input v-model="ruleForm.caipinOrderTruePrice"
                                     placeholder="实付价格/积分" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   canzhuoId: [
                              { required: true, message: '餐桌不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   caipinOrderTruePrice: [
                              { required: true, message: '实付价格/积分不能为空', trigger: 'blur' },
        ...
        created() {
         ...
         this.$http({
             url: `canzhuo/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.canzhuoOptions = data.data.list;
            }
         });
         this.$http({
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.canzhuoChange(data.data.canzhuoId)
