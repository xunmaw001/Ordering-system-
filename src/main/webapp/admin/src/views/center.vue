     ...
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='余额' prop="newMoney">
               <el-input v-model="ruleForm.newMoney" disabled  placeholder='余额' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='现积分' prop="yonghuNewJifen">
               <el-input v-model="ruleForm.yonghuNewJifen" disabled placeholder='现积分' clearable></el-input>
           </el-form-item>
         </el-col>
