    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.caipinPhoto" label="菜品照片" prop="caipinPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.caipinPhoto?ruleForm.caipinPhoto:''"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="购买获得积分" prop="caipinPrice">
                       <el-input v-model="ruleForm.caipinPrice"
                                 placeholder="购买获得积分" clearable  :readonly="ro.caipinPrice"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="购买获得积分" prop="caipinPrice">
                           <el-input v-model="ruleForm.caipinPrice"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价/积分" prop="caipinNewMoney">
                       <el-input v-model="ruleForm.caipinNewMoney"
                                 placeholder="现价/积分" clearable  :readonly="ro.caipinNewMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="现价/积分" prop="caipinNewMoney">
                           <el-input v-model="ruleForm.caipinNewMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="菜品简介" prop="caipinContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.caipinContent" label="菜品简介" prop="caipinContent">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.caipinOldMoney = true;
                this.ro.caipinNewMoney = true;
            }
